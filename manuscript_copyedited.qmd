...
Mean relative bias (%) in structural fixed effects, residual variability, and random-effect standard deviations for the dense Phase 1 sampling design, by posterior architecture, variational family, and $K$. Values are mean relative bias with the standard deviation across replicates in parentheses.
:::

::: {#supptbl-phase1-sparse}
{{< include publication/tables/table_phase1_sparse.md >}}

Mean relative bias (%) in structural fixed effects, residual variability, and random-effect standard deviations for the sparse Phase 1 sampling design, by posterior architecture, variational family, and $K$. Values are mean relative bias with the standard deviation across replicates in parentheses.
:::
